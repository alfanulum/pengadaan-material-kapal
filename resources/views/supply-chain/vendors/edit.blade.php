    ...
    <div class="py-6">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white p-6 shadow rounded-lg">
                ...
                <form action="{{ route('supply-chain.vendors.update', $vendor) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="alamat" rows="3" class="w-full border-gray-300 rounded-lg">{{ old('alamat', $vendor->alamat) }}</textarea>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <select name="status" class="w-full border-gray-300 rounded-lg">
                            ...
                            <option value="nonaktif" {{ $vendor->status == 'nonaktif' ? 'selected' : '' }}>Nonaktif
                            </option>
                        </select>
                    </div>
