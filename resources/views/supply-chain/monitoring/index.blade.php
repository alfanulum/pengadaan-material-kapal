        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
            <div>
                <div class="flex items-center gap-2 text-sm text-slate-500 mb-1">
                    ...
                    <span>/</span>
                    <span class="text-slate-900 font-semibold">Monitoring Pengadaan</span>
                </div>
                <h2 class="font-bold text-2xl text-slate-900 leading-tight">
                    Monitoring Pengadaan Material
                </h2>
                <p class="text-sm text-slate-500 mt-1">
                    Daftar tender dan Purchase Order yang sedang dipantau proses pengirimannya.
                </p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                @empty
                    <div class="md:col-span-2 lg:col-span-3 py-16 text-center bg-white rounded-3xl border border-slate-200">
                        ...
                        <p class="text-slate-500 mt-2">Daftar monitoring akan muncul setelah ada PO yang diterbitkan.</p>
                    </div>
                @endforelse
            </div>
