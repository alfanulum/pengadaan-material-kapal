                    ...
                    @foreach($newRequests as $newReq)
                        <div class="py-4 flex flex-col md:flex-row gap-4 items-start md:items-center justify-between hover:bg-slate-50/50 transition rounded-xl p-4 -mx-4">
                            ...
                            <div class="mt-2 md:mt-0">
                                <a href="{{ route('supply-chain.material-requests.show', $newReq->id) }}" class="inline-flex items-center justify-center px-4 py-2 bg-gradient-to-r from-slate-900 to-blue-900 text-white rounded-lg text-sm font-semibold hover:from-slate-800 hover:to-blue-800 hover:shadow-lg transition shadow-md shadow-blue-900/20 whitespace-nowrap">
                                    Detail
                                </a>
                            </div>
                        </div>
